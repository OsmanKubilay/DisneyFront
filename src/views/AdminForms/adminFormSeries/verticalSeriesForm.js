...
const VerticalSeriesForm = ({ row, show, handleToggle, onResult }) => {
  ...
  // const options = [
  //   { value: values?.Category?.id, label: values?.Category?.id },
  // ];
  return (
    <>
      <Modal
...
export default VerticalSeriesForm;
