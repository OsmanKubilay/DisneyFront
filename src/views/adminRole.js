...
import Modal from "./AdminForms/adminFormRole/verticalRoleForm";
...
import {
  handleAdminRoleList,
  handleClearAdminRoleList,
} from "../Redux/adminRole";

const endPointGetAll = "https://localhost:7112/api/Role/GetAllRole";
const endPointDelete = "https://localhost:7112/api/Role/DeleteRole";
const endPointAddorUpdate = "https://localhost:7112/api/Role/AddOrUpdateRole";
...
const Role = () => {
  const roleList = useSelector((state) => state.adminRole.adminRoleList);
  ...
  const getRoleList = () => {
    ...
    axios
      ...
      .then((res) => {
        console.log(res);
        dispatch(handleAdminRoleList(res.data));
      })
      .catch((err) => console.log(err));
  };
  ...
  useEffect(() => {
    ...
    return () => {
      dispatch(handleClearAdminRoleList());
    };
  }, [dispatch]);
